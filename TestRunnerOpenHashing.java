...
public class TestRunnerOpenHashing extends TestGUI.TestData{ 
   ...
   public static void runTests() {  //Your test sequence must be within a method called runTests()
      ...
      message("Testing a PhoneBook with an initial capacity of 4 and LoadFactor of 50%.  This will mean that it WILL resize/rehash (probably twice) when loading 10 entries.");
